                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       case 2:  // CourseRegistrationApp/Server/enroll
       {
         ...
         String dept = in.read_string ();
         boolean swapOp = in.read_boolean ();
         String $result = null;
         $result = this.enroll (courseId, studentId, term, dept, swapOp);
         out = $rh.createReply();
       ...
       case 8:  // CourseRegistrationApp/Server/swapCourse
       {
         ...
         String term = in.read_string ();
         String $result = null;
         $result = this.swapCourse (studentIid, oldCourseId, newCourseId, dept, term);
         out = $rh.createReply();
         out.write_string ($result);
         break;
       }
