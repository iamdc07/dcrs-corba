...
public class _ServerStub extends org.omg.CORBA.portable.ObjectImpl implements CourseRegistrationApp.Server
{
  ...
  public boolean swapCourse (String studentIid, String oldCourseId, String newCourseId, String dept)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                ...
                return swapCourse (studentIid, oldCourseId, newCourseId, dept        );
            } finally {
                _releaseReply ($in);
            }
  } // swapCourse
