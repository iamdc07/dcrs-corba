...
public class _ServerStub extends org.omg.CORBA.portable.ObjectImpl implements CourseRegistrationApp.Server
{
  ...
  public String enroll (String courseId, String studentId, String term, String dept)
  {
            ...
            try {
                ...
                return enroll (courseId, studentId, term, dept        );
            } finally {
                _releaseReply ($in);
            }
  } // enroll
  ...
  public boolean getClassSchedule (String studentId, CourseRegistrationApp.TermHolder term, CourseRegistrationApp.CoursesHolder courses)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                ...
                $in = _invoke ($out);
                boolean $result = $in.read_boolean ();
                term.value = CourseRegistrationApp.TermHelper.read ($in);
                courses.value = CourseRegistrationApp.CoursesHelper.read ($in);
                return $result;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
                ...
                return getClassSchedule (studentId, term, courses        );
            } finally {
                _releaseReply ($in);
            }
  } // getClassSchedule
