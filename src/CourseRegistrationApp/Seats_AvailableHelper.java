...
/**
* CourseRegistrationApp/Seats_AvailableHelper.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from dcrs.idl
* Sunday, November 4, 2018 3:43:08 o'clock PM EST
*/

abstract public class Seats_AvailableHelper
{
  private static String  _id = "IDL:CourseRegistrationApp/Seats_Available:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (CourseRegistrationApp.Seats_AvailableHelper.id (), "Seats_Available", __typeCode);
    }
    return __typeCode;
  }
