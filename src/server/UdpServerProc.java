...
import CourseRegistrationApp.Seats_AvailableHolder;
...
public class UdpServerProc implements Runnable {
    ...
    CoursesHolder course;
    Seats_AvailableHolder seats_available;
...
//		this.logs = logs;
    ...
    public void run() {
        ...
        try {
            ...
            String message;
            HashMap<String, Integer> coursesAvailable;
...
//			System.out.println("Reply received from the server with port number " + "6785" + " is: "
